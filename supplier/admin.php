<html>
    <head>
        ...
        $batas = 10;
        $value = mysql_num_rows(mysql_query("SELECT * FROM user WHERE hak_supplier='1'"));
                              ...
                              <div class="box-body no-padding">
                                <table class="table">
                                  <tr>
                                    ...
                                    $quer = "SELECT * FROM user WHERE hak_supplier='1' AND block='1' ORDER BY  `id_user` DESC LIMIT $posisi,$batas";
